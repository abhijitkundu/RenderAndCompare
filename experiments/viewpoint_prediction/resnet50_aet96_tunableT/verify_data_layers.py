...
if __name__ == '__main__':
    ...
    parser.add_argument("-d", "--dataset", default=osp.join(root_dir, 'data', 'pascal3D', 'pascal3d_voc2012_val_easy', 'pascal3d_voc2012_val_easy_car.json'), help="Dataset JSON file")
